...
Projetos precisam de apoio financeiro, coisa que eu não tenho. Tudo o que está aqui é fruto de meu trabalho e pesquisa ao longo dos anos. Para que o NEORICALEX exista é necessário dinheiro. Então a melhor forma de monetizar que encontrei foi a de produzir um Curso Online a que dei o nome de [COPED](./coped/README.md).
